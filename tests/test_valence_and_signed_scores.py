...
def test_valence_priority_aspect_over_bodies():
    ...
    val, factor = combine_valence(
        moving="venus",
        target="jupiter",
        contact_kind="aspect_square",
        aspect_name="square",
    )
...
def test_bodies_vote_when_aspect_neutral():
    ...
    val, factor = combine_valence(
        moving="moon",
        target="saturn",
        contact_kind="aspect_conjunction",
...
def test_neutral_amplify_vs_attenuate():
    ...
    val2, f2 = combine_valence(
        moving="neptune",
        target="neptune",
        contact_kind="aspect_quincunx",
        aspect_name="quincunx",
    )
