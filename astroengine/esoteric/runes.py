...
ELDER_FUTHARK_RUNES: tuple[Rune, ...] = (
    Rune(
        ...
        "Cattle / Wealth",
        "Fire",
        ("abundance", "mobility", "value"),
    ),
    Rune(
        2, "Uruz", "U", "u", "Aurochs", "Earth", ("strength", "vitality", "endurance")
    ),
    Rune(
        3,
        "Thurisaz",
    ...
    Rune(
        ...
        "Odin / Mouth",
        "Air",
        ("communication", "inspiration", "ancestral guidance"),
    ),
    Rune(5, "Raidho", "R", "r", "Journey", "Air", ("travel", "rhythm", "order")),
    Rune(
        6, "Kenaz", "K", "k", "Torch", "Fire", ("illumination", "craft", "revelation")
    ),
    Rune(
        7,
        "Gebo",
        ...
        "Gift",
        "Air",
        ("exchange", "partnership", "sacred contract"),
    ),
    ...
    Rune(
        ...
        "Hail",
        "Water",
        ("disruption", "natural forces", "transformation"),
    ),
    Rune(
        10,
        "Nauthiz",
        ...
        "Need",
        "Fire",
        ("constraint", "necessity", "innovation"),
    ),
    Rune(11, "Isa", "I", "i", "Ice", "Water", ("stillness", "focus", "preservation")),
    Rune(
        12, "Jera", "J", "j", "Year / Harvest", "Earth", ("cycles", "reward", "timing")
    ),
    Rune(
        13,
        "Eihwaz",
        ...
        "Yew",
        "Fire",
        ("endurance", "initiation", "protection"),
    ),
    Rune(
        14,
        "Perthro",
        ...
        "Lot Cup",
        "Water",
        ("mystery", "fate", "hidden things"),
    ),
    Rune(
        15, "Algiz", "Z", "z", "Elk", "Air", ("protection", "higher self", "alertness")
    ),
    ...
    Rune(
        ...
        "Man",
        "Air",
        ("humanity", "cooperation", "self-awareness"),
    ),
    ...
    Rune(
        ...
        "Seed / Ing",
        "Earth",
        ("gestation", "potential", "completion"),
    ),
    Rune(
        23, "Dagaz", "D", "d", "Day", "Fire", ("breakthrough", "clarity", "awakening")
    ),
    Rune(
        24,
        "Othala",
