...
I_CHING_HEXAGRAMS: tuple[Hexagram, ...] = (
    ...
    Hexagram(
        3, "屯", "Zhūn", "Difficulty at the Beginning", ("birth", "trial", "endurance")
    ),
    ...
    Hexagram(
        7, "師", "Shī", "The Army", ("discipline", "organization", "collective action")
    ),
    ...
    Hexagram(
        ...
        ("gentle influence", "preparation", "incremental gain"),
    ),
    ...
    Hexagram(
        ...
        "Tóng Rén",
        "Fellowship with Men",
        ("community", "shared vision", "alliances"),
    ),
    Hexagram(
        14,
        "大有",
        ...
        ("abundance", "nobility", "responsibility"),
    ),
    ...
    Hexagram(
        18, "蠱", "Gǔ", "Work on the Decayed", ("remedy", "repair", "responsibility")
    ),
    Hexagram(19, "臨", "Lín", "Approach", ("care", "oversight", "nurture")),
    Hexagram(20, "觀", "Guān", "Contemplation", ("reflection", "ritual", "overview")),
    Hexagram(
        21, "噬嗑", "Shì Kè", "Biting Through", ("decisiveness", "clarity", "justice")
    ),
    ...
    Hexagram(
        ...
        ("restraint", "accumulation", "strength"),
    ),
    ...
    Hexagram(
        33, "遯", "Dùn", "Retreat", ("withdrawal", "strategy", "self-preservation")
    ),
    Hexagram(
        34,
        "大壯",
        "Dà Zhuàng",
        "Power of the Great",
        ("vital force", "momentum", "assertion"),
    ),
    ...
    Hexagram(
        ...
        ("concealment", "injury", "guard inner fire"),
    ),
    Hexagram(
        37, "家人", "Jiā Rén", "The Family", ("roles", "home", "domestic harmony")
    ),
    Hexagram(
        38,
        "睽",
        "Kuí",
        "Opposition",
        ("divergence", "individuality", "complementarity"),
    ),
    ...
    Hexagram(
        ...
        "Guài",
        "Breakthrough",
        ("resolution", "declaration", "decisive action"),
    ),
    Hexagram(
        44, "姤", "Gòu", "Coming to Meet", ("encounter", "temptation", "sudden contact")
    ),
    Hexagram(
        45, "萃", "Cuì", "Gathering Together", ("assembly", "community", "celebration")
    ),
    Hexagram(
        46, "升", "Shēng", "Pushing Upward", ("gradual advance", "effort", "aspiration")
    ),
    Hexagram(
        47, "困", "Kùn", "Oppression", ("constraint", "exhaustion", "inner strength")
    ),
    Hexagram(48, "井", "Jǐng", "The Well", ("resources", "depth", "renewal")),
    Hexagram(49, "革", "Gé", "Revolution", ("change", "molting", "radical shift")),
    Hexagram(
        50, "鼎", "Dǐng", "The Cauldron", ("transformation", "culture", "nourishment")
    ),
    Hexagram(51, "震", "Zhèn", "The Arousing", ("shock", "awakening", "movement")),
    Hexagram(52, "艮", "Gèn", "Keeping Still", ("meditation", "stillness", "center")),
    Hexagram(
        53, "漸", "Jiàn", "Development", ("gradual progress", "fidelity", "evolution")
    ),
    Hexagram(
        54,
        "歸妹",
        "Guī Mèi",
        "The Marrying Maiden",
        ("transition", "adaptation", "second place"),
    ),
    ...
    Hexagram(
        59, "渙", "Huàn", "Dispersion", ("dissolve barriers", "forgiveness", "release")
    ),
    ...
    Hexagram(
        ...
        ("attention to detail", "caution", "modesty"),
    ),
    Hexagram(
        63, "既濟", "Jì Jì", "After Completion", ("culmination", "order", "maintenance")
    ),
    Hexagram(
        64,
        "未濟",
        "Wèi Jì",
        "Before Completion",
        ("transition", "final steps", "alertness"),
    ),
)
