...
from pydantic import BaseModel, ConfigDict, Field, ValidationInfo, conint, constr, field_validator
...
class AspectSearchRequest(BaseModel):
    ...
    pairs: list[tuple[StrName, StrName]] | None = Field(default=None)

    orb_policy_id: int | None = Field(default=None)
    orb_policy_inline: OrbPolicyInline | None = Field(default=None)
